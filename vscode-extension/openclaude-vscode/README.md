# XETH--7 VS Code Extension

A practical VS Code companion for XETH--7 with a project-aware **Control Center**, predictable terminal launch behavior, and quick access to useful XETH--7 workflows.

## Features

- **Real Control Center status** in the Activity Bar:
  - whether the configured `xeth7` command is installed
...
- **Project-aware launch behavior**:
  - `Launch XETH--7` launches from the active editor's workspace when possible
...
- **Built-in dark theme**: `XETH--7 Terminal Black`

## Requirements

- VS Code `1.95+`
- `xeth7` available in your terminal PATH

## Commands

- `XETH--7: Open Control Center`
- `XETH--7: Launch in Terminal`
- `XETH--7: Launch in Workspace Root`
- `XETH--7: Open Repository`
- `XETH--7: Open Setup Guide`
- `XETH--7: Open Workspace Profile`

## Settings

- `openclaude.launchCommand` (default: `xeth7`)
- `openclaude.terminalName` (default: `XETH--7`)
