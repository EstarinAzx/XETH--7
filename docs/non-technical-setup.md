# XETH--7 for Non-Technical Users
...
XETH--7 lets you use an AI coding assistant with different model providers such as:
...
After you run `xeth7`, the CLI should start and wait for your prompt.
