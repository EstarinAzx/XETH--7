...
const darkAnsiTheme: Theme = {
  ...
  userMessageBackgroundHover: 'ansi:green',
  messageActionsBackground: 'ansi:green',
  selectionBg: 'ansi:cyan', // darker named bg for dark-ansi; bright fgs stay readable
  bashMessageBackgroundColor: 'ansi:green',

  memoryBackgroundColor: 'ansi:green',
  rate_limit_fill: 'ansi:cyanBright',
  rate_limit_empty: 'ansi:yellow',
...
const darkTheme: Theme = {
  autoAccept: 'rgb(214,255,61)',
  bashBorder: 'rgb(214,255,61)',
  claude: 'rgb(84,236,255)',
  claudeShimmer: 'rgb(188,248,255)',
  claudeBlue_FOR_SYSTEM_SPINNER: 'rgb(84,236,255)',
  claudeBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(188,248,255)',
  permission: 'rgb(84,236,255)',
  permissionShimmer: 'rgb(188,248,255)',
  planMode: 'rgb(214,255,61)',
  ide: 'rgb(84,236,255)',
  promptBorder: 'rgb(214,255,61)',
  promptBorderShimmer: 'rgb(0,240,228)',
  text: 'rgb(236,245,223)',
  inverseText: 'rgb(6,6,16)',
  inactive: 'rgb(132,155,74)',
  inactiveShimmer: 'rgb(190,214,124)',
  subtle: 'rgb(43,54,22)',
  suggestion: 'rgb(84,236,255)',
  remember: 'rgb(214,255,61)',
  background: 'rgb(214,255,61)',
  success: 'rgb(84,236,255)',
  error: 'rgb(255,96,72)',
  warning: 'rgb(214,255,61)',
  merged: 'rgb(214,255,61)',
  warningShimmer: 'rgb(238,255,146)',
  diffAdded: 'rgb(22,42,34)',
  diffRemoved: 'rgb(88,46,32)',
  diffAddedDimmed: 'rgb(28,34,24)',
  diffRemovedDimmed: 'rgb(58,36,28)',
  diffAddedWord: 'rgb(168,255,248)',
  diffRemovedWord: 'rgb(255,150,108)',
  red_FOR_SUBAGENTS_ONLY: 'rgb(255,96,72)',
  blue_FOR_SUBAGENTS_ONLY: 'rgb(84,236,255)',
  green_FOR_SUBAGENTS_ONLY: 'rgb(84,236,255)',
  yellow_FOR_SUBAGENTS_ONLY: 'rgb(214,255,61)',
  purple_FOR_SUBAGENTS_ONLY: 'rgb(214,255,61)',
  orange_FOR_SUBAGENTS_ONLY: 'rgb(255,150,108)',
  pink_FOR_SUBAGENTS_ONLY: 'rgb(214,255,61)',
  cyan_FOR_SUBAGENTS_ONLY: 'rgb(84,236,255)',
  professionalBlue: 'rgb(84,236,255)',
  chromeYellow: 'rgb(214,255,61)',
  clawd_body: 'rgb(84,236,255)',
  clawd_background: 'rgb(12,14,9)',
  userMessageBackground: 'rgb(18, 24, 14)',
  userMessageBackgroundHover: 'rgb(24, 34, 18)',
  messageActionsBackground: 'rgb(14, 44, 46)',
  selectionBg: 'rgb(18, 84, 78)',
  bashMessageBackgroundColor: 'rgb(14, 20, 12)',
  memoryBackgroundColor: 'rgb(10, 34, 36)',
  rate_limit_fill: 'rgb(84,236,255)',
  rate_limit_empty: 'rgb(51,64,23)',
  fastMode: 'rgb(214,255,61)',
  fastModeShimmer: 'rgb(238,255,146)',
  briefLabelYou: 'rgb(84,236,255)',
  briefLabelClaude: 'rgb(214,255,61)',
  rainbow_red: 'rgb(255,96,72)',
  rainbow_orange: 'rgb(255,150,108)',
  rainbow_yellow: 'rgb(214,255,61)',
  rainbow_green: 'rgb(174,255,92)',
  rainbow_blue: 'rgb(84,236,255)',
  rainbow_indigo: 'rgb(120,242,255)',
  rainbow_violet: 'rgb(168,255,248)',
  rainbow_red_shimmer: 'rgb(255,160,132)',
  rainbow_orange_shimmer: 'rgb(255,198,170)',
  rainbow_yellow_shimmer: 'rgb(238,255,146)',
  rainbow_green_shimmer: 'rgb(218,255,174)',
  rainbow_blue_shimmer: 'rgb(188,248,255)',
  rainbow_indigo_shimmer: 'rgb(212,252,255)',
  rainbow_violet_shimmer: 'rgb(224,255,252)',
}
...
const darkDaltonizedTheme: Theme = {
  autoAccept: 'rgb(214,255,61)',
  bashBorder: 'rgb(214,255,61)',
  claude: 'rgb(116,168,255)',
  claudeShimmer: 'rgb(176,208,255)',
  claudeBlue_FOR_SYSTEM_SPINNER: 'rgb(116,168,255)',
  claudeBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(176,208,255)',
  permission: 'rgb(116,168,255)',
  permissionShimmer: 'rgb(176,208,255)',
  planMode: 'rgb(214,255,61)',
  ide: 'rgb(116,168,255)',
  promptBorder: 'rgb(214,255,61)',
  promptBorderShimmer: 'rgb(116,168,255)',
  text: 'rgb(230,242,210)',
  inverseText: 'rgb(6,8,18)',
  inactive: 'rgb(150,168,98)',
  inactiveShimmer: 'rgb(198,212,146)',
  subtle: 'rgb(46,54,24)',
  suggestion: 'rgb(116,168,255)',
  remember: 'rgb(214,255,61)',
  background: 'rgb(214,255,61)',
  success: 'rgb(116,168,255)',
  error: 'rgb(255,120,120)',
  warning: 'rgb(214,255,61)',
  merged: 'rgb(214,255,61)',
  warningShimmer: 'rgb(236,255,156)',
  diffAdded: 'rgb(18,42,54)',
  diffRemoved: 'rgb(92,60,30)',
  diffAddedDimmed: 'rgb(30,40,44)',
  diffRemovedDimmed: 'rgb(62,48,30)',
  diffAddedWord: 'rgb(116,168,255)',
  diffRemovedWord: 'rgb(255,176,120)',
  red_FOR_SUBAGENTS_ONLY: 'rgb(255,120,120)',
  blue_FOR_SUBAGENTS_ONLY: 'rgb(116,168,255)',
  green_FOR_SUBAGENTS_ONLY: 'rgb(116,168,255)',
  yellow_FOR_SUBAGENTS_ONLY: 'rgb(214,255,61)',
  purple_FOR_SUBAGENTS_ONLY: 'rgb(214,255,61)',
  orange_FOR_SUBAGENTS_ONLY: 'rgb(255,176,92)',
  pink_FOR_SUBAGENTS_ONLY: 'rgb(214,255,61)',
  cyan_FOR_SUBAGENTS_ONLY: 'rgb(116,168,255)',
  professionalBlue: 'rgb(116,168,255)',
  chromeYellow: 'rgb(214,255,61)',
  clawd_body: 'rgb(116,168,255)',
  clawd_background: 'rgb(14,16,10)',
  userMessageBackground: 'rgb(20, 24, 14)',
  userMessageBackgroundHover: 'rgb(28, 34, 18)',
  messageActionsBackground: 'rgb(18, 42, 48)',
  selectionBg: 'rgb(16, 82, 106)',
  bashMessageBackgroundColor: 'rgb(16, 20, 12)',
  memoryBackgroundColor: 'rgb(14, 28, 34)',
  rate_limit_fill: 'rgb(116,168,255)',
  rate_limit_empty: 'rgb(54,64,24)',
  fastMode: 'rgb(214,255,61)',
  fastModeShimmer: 'rgb(236,255,156)',
  briefLabelYou: 'rgb(116,168,255)',
  briefLabelClaude: 'rgb(214,255,61)',
  rainbow_red: 'rgb(255,120,120)',
  rainbow_orange: 'rgb(255,176,92)',
  rainbow_yellow: 'rgb(214,255,61)',
  rainbow_green: 'rgb(198,236,120)',
  ...
  rainbow_yellow_shimmer: 'rgb(236,255,156)',
  rainbow_green_shimmer: 'rgb(226,246,168)',
