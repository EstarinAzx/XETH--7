...
export function WebFetchPermissionRequest(t0) {
  ...
  if ($[5] !== hostname) {
    ...
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
      t5 = {
        label: <Text>No, and tell Stratagem what to do differently <Text bold={true}>(esc)</Text></Text>,
        value: "no"
      };
      $[9] = t5;
    } else {
  ...
  if ($[27] === Symbol.for("react.memo_cache_sentinel")) {
    t11 = <Text>Do you want to allow Stratagem to fetch this content?</Text>;
    $[27] = t11;
  } else {
    t11 = $[27];
  }
